...
class Segment():
    ...
    def __init__(self, unit, reading, info=''):
        self.unit = unit
        ...
        if tools.is_kana(char):
            ...
            if len(reading) == 0:
                ...
                if char == reading[0]:
                    ...
                    tmp_segments.append(Segment(char, char, 'kana'))
            ...
            for cr in char_readings:
                ...
                if cr.has_okurigana == True:
                    ...
                    if r == reading[:rl] and ot == o:
                        ...
                        tmp_segments = copy.copy(segments)
                        tmp_segments.append(Segment(char, r, 'kanji with okurigana (%s)'%o))
                        tmp_segments.append(Segment(o, o, 'okurigana'))
                    ...
                    if reading.startswith(r):
                        ...
                        tmp_segments = copy.copy(segments)
                        tmp_segments.append(Segment(char, r, 'kanji'))
                        get_individual_readings(tmp_word, tmp_reading, tmp_segments, tmp_found, solutions)
